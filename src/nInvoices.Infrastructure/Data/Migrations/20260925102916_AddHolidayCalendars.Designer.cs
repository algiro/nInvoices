...
namespace nInvoices.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260925102916_AddHolidayCalendars")]
    partial class AddHolidayCalendars
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("nInvoices.Core.Entities.HolidayCalendar", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("nInvoices.Core.Entities.HolidayRule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("HolidayRules", (string)null);
                });
            ...
            modelBuilder.Entity("nInvoices.Core.Entities.HolidayRule", b =>
                {
                    b.HasOne("nInvoices.Core.Entities.HolidayCalendar", "HolidayCalendar")
                        .WithMany("Rules")
