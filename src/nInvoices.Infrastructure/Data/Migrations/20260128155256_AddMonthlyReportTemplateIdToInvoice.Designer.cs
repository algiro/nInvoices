...
namespace nInvoices.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260128155256_AddMonthlyReportTemplateIdToInvoice")]
    partial class AddMonthlyReportTemplateIdToInvoice
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("nInvoices.Core.Entities.InvoiceTaxLine", b =>
                {
                    ...
                    b.OwnsOne("nInvoices.Core.ValueObjects.Money", "BaseAmount", b1 =>
                        {
                            b1.Property<long>("InvoiceTaxLineId")
                                .HasColumnType("INTEGER");
                            ...
                            b1.HasKey("InvoiceTaxLineId");

                            b1.ToTable("InvoiceTaxLines");

                            b1.WithOwner()
                                .HasForeignKey("InvoiceTaxLineId");
                        });

                    b.OwnsOne("nInvoices.Core.ValueObjects.Money", "TaxAmount", b1 =>
                        {
                            b1.Property<long>("InvoiceTaxLineId")
                                .HasColumnType("INTEGER");
